...
//                     Login with your existing email/password or Google
//                   </div>
//                 </div>
...
//                   </div>
//                   <div style={{ fontSize: 12, color: "var(--muted2)" }}>
//                     Enter the phone number registered by gym admin
//                   </div>
//                 </div>
...
//                   {[
//                     "Your number must already be added by admin",
//                     "One phone number can activate only one member account",
//                     "Use Google to connect your app login",
//                   ].map((f, i) => (
//                     <div
//                       key={i}
//                       style={{
            ...
            {memberTab === "activate" && (
              <form onSubmit={handleActivateMember}>
                <div style={{ textAlign: "center", marginBottom: 18 }}>
                  ...
                  <div style={{ fontSize: 12, color: "var(--muted2)" }}>
                    First enter phone number added by gym admin
                  </div>
                </div>
                ...
                >
                  ...
                  {[
                    "No dummy Gmail can create member account",
                    "Phone number must already exist in admin member list",
            ...
            {memberTab === "login" && (
              <div>
                <div style={{ textAlign: "center", marginBottom: 18 }}>
                  ...
                  <div style={{ fontSize: 12, color: "var(--muted2)" }}>
                    Only activated members can login
                  </div>
                </div>
