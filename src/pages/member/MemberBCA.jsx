...
export default function MemberBCA() {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      try {
        const data = await getBCAReadings(membership.memberId);
  ...
  const chartData = useMemo(() => {
    return [...sortedReadings].reverse().map((r) => ({
      date: r.date?.slice(5),
    ...
    <LockGate feature="bca" membership={membership}>
      <div className="page-enter">
        <div className="topbar">
          <div className="page-title">My Body Analysis</div>
        </div>
            ...
            <>
              <div className="stats-grid mb-16">
                <StatCard
                  ...
                  cls="s-red"
                  valueClass="c-red"
                  sub={diff("weight") ? `${diff("weight")} vs prev` : ""}
                />
                ...
                <StatCard
                  ...
                  cls="s-green"
                  valueClass="c-green"
                  sub={diff("muscle") ? `${diff("muscle")} vs prev` : ""}
                />
                ...
                <div className="bca-bar-wrap">
                  ...
                  <div className="bca-track">
                    <div
                      ...
                      style={{
                        width: `${Math.min(Number(latest?.fat || 0), 100)}%`,
                      }}
                    />
                  </div>
                </div>
                ...
                <div className="bca-bar-wrap">
                  ...
                  <div className="bca-track">
                    <div
                      ...
                      style={{
                        width: `${Math.min(Number(latest?.water || 0), 100)}%`,
                      }}
                    />
                  </div>
                </div>
                ...
                <div className="bca-bar-wrap">
                  ...
                  <div className="bca-track">
                    <div
                      ...
                      style={{
                        width: `${Math.min(Number(latest?.muscle || 0), 100)}%`,
                      }}
                    />
                  </div>
                </div>
