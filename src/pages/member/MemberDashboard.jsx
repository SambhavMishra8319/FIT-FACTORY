...
//             <div
//               style={{ fontSize: 12, color: "var(--muted2)", marginTop: 10 }}
//             >
//               Starting at just{" "}
...
const SAMPLE_MEALS = [
  { time: "🌅 Early Morning", desc: "10 almonds + lemon water", kcal: 180 },
  { time: "🍳 Breakfast", desc: "Oats + banana + peanut butter", kcal: 520 },
  { time: "🍱 Lunch", desc: "2 roti + dal + rice + salad", kcal: 680 },
];
...
export default function MemberDashboard() {
  ...
  async function fetchData() {
    if (!profile?.phone && !membership?.memberId) {
      setLoading(false);
      return;
    }
    ...
    try {
      ...
      if (membership?.memberId) {
        ...
        setBcaLatest(!bcaSnap.empty ? bcaSnap.docs[0].data() : null);
  ...
  const goPremium = (path) => {
    if (isPaid) navigate(path);
    else navigate("/member/upgrade");
  };

  const getBookingBoxClass = (status) => {
    if (status === "approved") return "info-box success mt-10";
    if (status === "confirmed") return "info-box success mt-10";
    if (status === "rejected") return "info-box error mt-10";
    if (status === "completed") return "info-box success mt-10";
    return "info-box warning mt-10";
  };
      ...
      <div className="page-body">
        ...
        <div className="hero-banner mb-20" style={anim(0)}>
          ...
          <div className="hero-content">
            ...
            <div className="hero-actions">
              <button
                className="btn btn-primary tap-scale"
                onClick={() => goPremium("/member/workout")}
              >
                {isPaid ? "Start Workout" : "Unlock Workout"}
              </button>

              <button
                className="btn btn-outline tap-scale"
                onClick={() => goPremium("/member/progress")}
              >
                {isPaid ? "Track Progress" : "View Plans"}
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="profile-header mb-16" style={anim(0.05)}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <div className="profile-meta">
              📱 {profile?.phone || member?.phone || profile?.email || "Member"}
            </div>
        ...
        <div className="stats-grid mb-20" style={anim(0.1)}>
          ...
          <div className="stat-card s-blue" onClick={() => navigate("/member/card")} style={{ cursor: "pointer" }}>
            <div className="stat-label">Digital Card</div>
            <div className="stat-value c-blue" style={{ fontSize: 22 }}>📇</div>
            <div className="stat-sub">Tap to open</div>
          </div>

          <div className="stat-card s-gold" onClick={() => navigate("/member/equipment")} style={{ cursor: "pointer" }}>
            <div className="stat-label">Equipment</div>
            <div className="stat-value c-gold" style={{ fontSize: 22 }}>🔧</div>
            <div className="stat-sub">Free guide</div>
          </div>
        </div>

        <div className="card mb-20" style={anim(0.12)}>
          <div className="card-title">Quick Actions</div>

          <div className="quick-actions-grid">
            <button className="btn btn-primary" onClick={() => navigate("/member/card")}>
              📇 My Card
            </button>

            <button className="btn btn-outline" onClick={() => goPremium("/member/workout")}>
              🏋 Workout
            </button>

            <button className="btn btn-outline" onClick={() => goPremium("/member/diet")}>
              🥗 Diet
            </button>

            <button className="btn btn-outline" onClick={() => goPremium("/member/steam")}>
              🌫 Steam
            </button>
          </div>
        </div>

        <div className="stats-grid mb-20" style={anim(0.14)}>
        ...
        <div style={{ ...anim(0.24), marginTop: 24 }}>
          <div className="section-header mb-12">
            <div className="section-title">🥗 Today's Diet</div>
        ...
        <div style={{ ...anim(0.3), marginTop: 24 }}>
          <div className="section-header mb-12">
            <div className="section-title">📊 Body Analysis (BCA)</div>
        ...
        <div style={{ ...anim(0.38), marginTop: 24 }}>
          <div className="section-header mb-12">
            <div className="section-title">💺 Massage Chair</div>
        ...
        {!isPaid && (
          ...
          >
            ...
            <div style={{ fontSize: 12, color: "var(--muted2)", marginTop: 10 }}>
              Starting at just{" "}
              <strong style={{ color: "var(--gold)" }}>₹1,499</strong> · Visit
              F2 Fit Factory, Mandla
            </div>
          </div>
        )}

        <div style={{ ...anim(0.46), marginTop: 24 }}>
          <div
            className="card tap-scale"
            style={{
              cursor: "pointer",
