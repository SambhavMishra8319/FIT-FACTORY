...
// const dailyTagline =
//   taglines[new Date().getDate() % taglines.length];
...
//   // const [goal, setGoal] = useState("General Fitness");
//   // const userGoal = data.goal || "General Fitne.ss";

//   const today = format(new Date(), "yyyy-MM-dd");
//   const hour = new Date().getHours();
//   // const exercises = WORKOUT_PLANS[goal] || [];
//   const greeting =
...
//       setMember({ id: mSnap.docs[0].id, ...data });

//       const userGoal = data.goal || "General Fitness";
//       setGoal(userGoal);
...
//       setWorkout(
//         !workoutSnap.empty
//           ? workoutSnap.docs[0].data().exercises || []
//           : []
//       );
//     }
...
//   //   }
//   // }
//   // async function loadWorkout(currentGoal) {
//   //   try {
//   //     const workoutSnap = await getDocs(
//   //       query(
//   //         collection(db, "workout_plans"),
//   //         where("goal", "==", currentGoal),
//   //       ),
//   //     );

//   //     if (!workoutSnap.empty) {
//   //       setWorkout(workoutSnap.docs[0].data().exercises || []);
//   //     } else {
//   //       setWorkout([]);
//   //     }
//   //   } catch (e) {
...
//     ...style,
//   });
//   const displayWorkout = workout.length ? workout : SAMPLE_EXERCISES;
//   if (mLoading)
//     return (
...
//               <div
//                 key={i}
//                 className={`slot ${i < 2 ? "booked" : ""} ${
//                   i === 2 ? "selected" : ""
//                 }`}
//               >
//                 <div className="slot-time">{t}</div>
//                 <div className="slot-label">
//                   {i < 2 ? "Booked" : "Available"}
//                 </div>
//               </div>
//             ))}
//           </div>
...
// // ) : (
// //   <>
// //     {ex.sets || 3} sets × {ex.reps || 12} reps · Rest {ex.rest || 60}s
// //   </>
// // )}
// //                     </div>
// //                   </div>
...
// //                 <div
// //                   key={i}
// //                   className={`slot ${i < 2 ? "booked" : ""} ${i === 2 ? "selected" : ""}`}
// //                 >
// //                   <div className="slot-time">{t}</div>
// //                   <div className="slot-label">
// //                     {i < 2 ? "Booked" : i === 2 ? "Available" : "Available"}
// //                   </div>
// //                 </div>
// //               ))}
// //             </div>
