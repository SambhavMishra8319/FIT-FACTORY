      ...
      <div className="page-body">
        ...
        <div className="card mb-20">
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              <h2 style={{ marginBottom: 6 }}>{member.name || "Unnamed"}</h2>
              ...
              {member.biometricId && (
                <div style={{ color: "var(--muted2)", fontSize: 13 }}>
                  🖐️ Biometric ID: {member.biometricId}
                </div>
              )}
            </div>
        ...
        <div className="stats-grid mb-20">
          ...
          <div className="stat-card s-gold">
            ...
            <div className="stat-value c-gold">{thisMonthCount}</div>
          </div>
          ...
          <div className="stat-card s-red">
            ...
            <div className="stat-value c-red">
              ₹{Number(member.balanceDue || 0).toLocaleString()}
            </div>
          </div>
        </div>
        ...
        <div className="card mb-20">
         ...
         /     <div>{member.phone || "—"}</div>
            ...
            <div className="form-group">
              <div className="form-label">Preferred Time</div>
              <div>{member.preferredTime || "—"}</div>
            </div>
            ...
            <div className="form-group">
              ...
              <div>{member.batchTiming || "—"}</div>
            </div>

            <div className="form-group">
              <div className="form-label">Biometric ID</div>
              <div>{member.biometricId || "—"}</div>
            </div>

            <div className="form-group">
              <div className="form-label">Referred By</div>
              <div>{member.referredBy || "—"}</div>
            </div>
          </div>
        </div>
        ...
        <div className="card mb-20">
          ...
          <div className="details-grid">
            <div className="form-group">
              ...
              <div>{member.height ? `${member.height} cm` : "—"}</div>
            </div>

            <div className="form-group">
              <div className="form-label">Weight</div>
              <div>{member.weight ? `${member.weight} kg` : "—"}</div>
            </div>

            <div className="form-group">
              <div className="form-label">BMI</div>
              <div>{member.bmi || "—"}</div>
            </div>

            <div className="form-group">
              <div className="form-label">Blood Group</div>
              <div>{member.bloodGroup || "—"}</div>
            </div>

            <div className="form-group">
              <div className="form-label">Medical Condition</div>
              <div>{member.medicalCondition || "—"}</div>
            </div>

            <div className="form-group">
              <div className="form-label">Previous Injury / Surgery</div>
              <div>{member.previousInjury || "—"}</div>
            </div>

            <div className="form-group">
              <div className="form-label">Medication</div>
              <div>{member.medication || "—"}</div>
            </div>

            <div className="form-group">
              <div className="form-label">Doctor Advice</div>
              <div>{member.doctorAdvice || "—"}</div>
            </div>
          </div>
        </div>
        ...
        <div className="card mb-20">
          ...
          <div className="details-grid">
            <div className="form-group">
              ...
              <div>{member.emergencyName || "—"}</div>
            </div>

            <div className="form-group">
              <div className="form-label">Relationship</div>
              <div>{member.emergencyRelation || "—"}</div>
            </div>

            <div className="form-group">
              <div className="form-label">Contact Number</div>
              <div>{member.emergencyPhone || "—"}</div>
            </div>
          </div>
        </div>
        ...
        <div className="card mb-20">
          ...
          <div className="details-grid">
            ...
            <div className="form-group">
              ...
              <div>{member.membershipStart || member.joinDate || "—"}</div>
            </div>
            ...
            <div className="form-group">
              <div className="form-label">Registration Fee</div>
              <div>₹{Number(member.registrationFee || 0).toLocaleString()}</div>
            </div>

            <div className="form-group">
              <div className="form-label">Membership Fee</div>
              <div>₹{Number(member.membershipFee || 0).toLocaleString()}</div>
            </div>

            <div className="form-group">
              <div className="form-label">Discount</div>
              <div>₹{Number(member.discount || 0).toLocaleString()}</div>
            </div>

            <div className="form-group">
              <div className="form-label">Total Amount</div>
              <div>₹{Number(member.totalAmount || 0).toLocaleString()}</div>
            </div>

            <div className="form-group">
              <div className="form-label">Amount Paid</div>
              <div>₹{Number(member.amountPaid || 0).toLocaleString()}</div>
            </div>
